package com.github.script.task.server.other.timer.config;

import com.github.script.task.server.other.timer.core.SimpleTaskTimerContainer;
import com.github.script.task.server.other.timer.core.SimpleTaskTimerCore;
import com.github.script.task.server.other.timer.core.SimpleTaskTimerDao;
...
@EnableScheduling
@ComponentScan({
        "com.github.script.task.server.other.timer.core",
        "com.github.script.task.server.other.timer.conf"
})
