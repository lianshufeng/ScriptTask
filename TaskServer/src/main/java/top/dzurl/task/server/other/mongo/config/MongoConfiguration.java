package top.dzurl.task.server.other.mongo.config;
...
import top.dzurl.task.server.other.mongo.config.converts.BigDecimalToDecimal128Converter;
import top.dzurl.task.server.other.mongo.config.converts.Decimal128ToBigDecimalConverter;
...
@Configuration
@EnableMongoAuditing
@ComponentScan("top.dzurl.task.server.other.mongo.helper")
