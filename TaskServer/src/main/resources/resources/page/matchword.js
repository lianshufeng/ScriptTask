 ...
 * 删除线索
 */
var removeMatchWord = function (id) {
    ...
    $(grid_selector).jqGrid({
        ...
        colModel: [
            ...
            },
            {
                ...
                sortable: false,
                formatter: function (val, options, rowdata) {
                    return '<button type="button" class="btn btn-bgc-tp btn-lighter-blue btn-h-primary btn-a-primary" data-toggle="modal" data-target="#update" onclick="setData(' + JSON.stringify(rowdata).replace(/"/g, '&quot;') + ')"><i class="fa fa-edit"></i></button> &nbsp;' +
                        '<button type="button" class="btn btn-bgc-tp btn-lighter-red btn-h-primary btn-a-primary"  onclick="removeMatchWord(\'' + rowdata.id + '\')"><i class="fa fa-trash-alt"></i></button>'
        ...
        serializeGridData: function (postData) {
            ...
            postData.collectionName = collectionName
